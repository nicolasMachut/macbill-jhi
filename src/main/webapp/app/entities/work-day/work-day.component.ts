...
export class WorkDayComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.workDayService
            ...
            .subscribe(
                (res: HttpResponse<IWorkDay[]>) => this.paginateWorkDays(res.body, res.headers),
    ...
    trackId(index: number, item: IWorkDay) {
        return item.id;
    }
    ...
    protected paginateWorkDays(data: IWorkDay[], headers: HttpHeaders) {
